...
function Chat({ pp, contact, msg, time, unreadMsgs, active }: any) {
  return (
    // Chat container
    <div
      className={`flex items-center cursor-pointer w-100 h-[85px] px-3 hover:bg-[#202d33] ${
        active ? "bg-[#202d33]" : ""
      }`}
    >
      {/* Profile picture */}
      ...
      {/* Info container */}
      <div className="flex flex-1 justify-between border-t border-neutral-700 w-100 h-100 py-3">
