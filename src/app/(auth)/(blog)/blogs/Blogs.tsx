...
import dashboard from "../../../../../public/doctordash.png";
              ...
              <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                <div className="e-card" style={{ textAlign: "center" }}>
                        ...
                        <tr>
                          ...
                          <td style={{ textAlign: "right" }}>
                            <div className="e-card-actions">
                              ...
                              >
                                <span
                                  className="e-btn-icon e-icons e-reveal-icon e-icon-right"
                                  style={{ margin: "0px" }}
                                ></span>
                              </button>
                            </div>
                  ...
                  >
                    ...
                    >
                      Microsoft has done extensive work to make JavaScript
                      easier to use. Microsoft TypeScript extends many familiar
                      features of .NET programming to JavaScript.
                    </div>
