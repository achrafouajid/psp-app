...
export default function AddPatient({
  ...
  type SectionVisibilityKeys = "info" | "socioDemo";
  const [sectionVisibility, setSectionVisibility] = useState<{
    [key in SectionVisibilityKeys]: boolean;
  }>({
    info: false,
    socioDemo: false,
  });
  const toggleSectionVisibility = (section: SectionVisibilityKeys) => {
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="flex">
          ...
          {sectionVisibility.info ? (
            <FaChevronUp
              className="text-[#396EA5] pl-2"
              size={30}
              onClick={() => toggleSectionVisibility("info")}
            />
          ) : (
            <FaChevronDown
              className="text-[#396EA5] pl-2"
        ...
        <div className="flex">
          ...
          {sectionVisibility.socioDemo ? (
            <FaChevronUp
              className="text-[#396EA5] pl-2"
              size={30}
              onClick={() => toggleSectionVisibility("socioDemo")}
            />
          ) : (
            <FaChevronDown
              className="text-[#396EA5] pl-2"
                ...
                <div className="flex flex-row">
                  ...
                  <div className="flex items-center mb-2 gap-1 ml-2">
                    <Checkbox
                      ...
                      isSelected={
                        formik.values.education == EducationEnum.Lycee
                      }
                      onChange={(e) =>
                        formik.setFieldValue(
                          "education",
                ...
                <div className="flex flex-row">
                  ...
                  <div className="flex items-center mb-2 gap-1 ml-2">
                    <Checkbox
                      ...
                      isSelected={
                        formik.values.habitat == HabitatEnum.SubUrbain
                      }
                      onChange={(e) =>
                        formik.setFieldValue(
                          "habitat",
              ...
              <div className=" md:w-1/2 items-center">
                ...
                >
                  <Radio
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("statusrequest", true)
                    }
                  >
                    Positive
                  </Radio>
